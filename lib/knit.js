...
(function (publish,require) {
        ...
        case 'string':
            if (_.indexOf(path.sep)!==-1 && fs.existsSync(path.resolve(caller_dir,_))) {
                ...
                try {
                    ...
                    if (! e instanceof Error || e.code !== 'MODULE_NOT_FOUND' || (typeof $ !== 'undefined' && $ !== '$unique') ) {
                        throw e
                    }
                }
            }
    ...
    function parse_array(e) {
        if (! e.some(function(c,i,a) {
            if (typeof c === 'function') {
                if (i != a.length-1) {
                    throw new Error("Function must ends a definition")
                } else {
                    knit.call(null,a.slice(0,-1), c)
                }
                return true
            }
            return false
