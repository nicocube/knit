...
(function (publish,require) {
	...
	function Binder(knit) {
		...
		this.toString = function () {
			return 'Binder{_to: '+asString(_to) + ', _kind: ' + _kind +'}'
		}
	}
	...
	function Config (knit) {
		var _stack = [],
			_known = require.main.paths.slice(),
			_config = {knit:knit}
